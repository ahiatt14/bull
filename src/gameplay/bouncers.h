...
#define BOUNCER_GRID_COLUMN_DEG_OFFSET 360 / BOUNCER_GRID_MAX_PER_ROW
#define BOUNCER_GRID_ROW_RADIUS_OFFSET 1
#define BOUNCERS_GRID_ROW_COUNT 20
#define BOUNCERS_GRID_MAX_COUNT (BOUNCER_GRID_COLUMN_DEG_OFFSET) * BOUNCERS_GRID_ROW_COUNT

struct bouncer_grid {
  uint32_t active_bouncers[BOUNCERS_GRID_ROW_COUNT];
