...
./tools/sourcify-png/bin/sourcify-png.exe assets/png/clod256.png \
3 src/headers/clod256_texture.h src/clod256_texture.c && \
./tools/sourcify-png/bin/sourcify-png.exe assets/png/concrete32bit.png \
3 src/headers/concrete_rgb_texture.h src/concrete_rgb_texture.c && \
