...
./${tools}obj-parser.exe assets/mesh/sky_plane.obj smooth &> src/headers/sky_plane_mesh.h && \
...
./${tools}headerfy-glsl.exe assets/glsl/sky_frag.glsl &> src/headers/sky_frag.h && \
./${tools}headerfy-glsl.exe assets/glsl/leaf_frag.glsl &> src/headers/leaf_frag.h && \
...
rm -f src/headers/sky_plane_mesh.h
